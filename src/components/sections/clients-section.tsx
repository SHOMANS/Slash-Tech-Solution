    ...
    <Section id="clients" className="bg-gray-50 dark:bg-gray-950">
      ...
      {clients.length > 0 && (
        <div className="relative mb-20">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 blur-md pointer-events-none">
            {clients.map((client) => (
      ...
      {testimonials.length > 0 && (
        <div className="mt-16 relative">
          ...
          <div className="relative">
            <div className="grid md:grid-cols-3 gap-8 blur-md pointer-events-none">
